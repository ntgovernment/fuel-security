...
│   │   └── components/
│   │       ├── alert.css             # Global alert banner styles: warning (#D6410A), information (#107CC0), critical (#A60F37); white inverse text + 24×24 close button anchored top-right
...
| ----------------------- | ----------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `alert.css`             | `.alert-warning`, `.alert-info`, `.alert-information`, `.alert-danger`, `.alert-critical` | Global alert banners with coloured backgrounds: warning `#D6410A` (orange), information `#107CC0` (blue), critical `#A60F37` (burgundy); white text, 20px bold title `!important`, 16px body `!important` (forces override of PROD cascade), white 24×24 close button absolutely positioned at `top: 16px; right: 16px`, flex layout |
